  ...
  <div className='undp-container'>
    <div className='flex-div gap-07 flex-hor-align-center margin-bottom-05'>
      <div className='flex-div flex-vert-align-center gap-02'>
        ...
        <div className='bold' style={{ color: CATCOLOR[0] }}>1st Round</div>
      </div>
      <div className='flex-div flex-vert-align-center gap-02'>
        <ColorBox style={{ backgroundColor: CATCOLOR[1] }} />
        <div className='bold' style={{ color: CATCOLOR[1] }}>2nd Round</div>
      </div>
      <div className='flex-div flex-vert-align-center gap-02'>
        <ColorBox style={{ backgroundColor: CATCOLOR[2] }} />
        <div className='bold' style={{ color: CATCOLOR[2] }}>3rd Round</div>
      </div>
    </div>
    <UnivariateMap />
  </div>
